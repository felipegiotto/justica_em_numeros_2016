...
begin
  ...
  (
    SELECT 
      ...
      /*** orgaoJulgador ***/
      /* codigoOrgao */
      serv_oj.cod_serventia ds_sigla,
      /* nomeOrgao */
      serv_oj.nom_org_julg ds_orgao_julgador,
      /* instancia */
      'ORIG' tp_instancia,
      /* codigoMunicipioIBGE */
    ...
    INNER JOIN tb_orgao_julgador oj ON 1=1
    ...
    (
      ...
      select 30373 cod_serventia, 39 num_org_julg, '1ª VARA DO TRABALHO DE ARIQUEMES/RO' nom_org_julg 
    ) serv_oj on 1=1
