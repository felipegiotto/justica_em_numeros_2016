...
/**
 * Fonte: http://www.javaworld.com/article/2077706/core-java/named-parameters-for-preparedstatement.html?page=2
 * 
 * 
			...
			if(inSingleQuote) {
				...
				if(c == '\'') {
					...
					inDoubleQuote = true;
						...
						&& (query.charAt(i+1) != ':') && (query.charAt(i-1) != ':')) { // @author fgiotto: ignorar typecasts do PostgreSQL, ex: "SELECT dt_inicio::date FROM tb_processo..."
					int j = i + 2;
