...
public class BenchmarkVariasOperacoes {
	...
	private static BenchmarkVariasOperacoes globalInstance;
	public static BenchmarkVariasOperacoes globalInstance() {
		if (globalInstance == null) {
			synchronized(LOGGER) {
				if (globalInstance == null) {
					globalInstance = new BenchmarkVariasOperacoes(true);
				}
			}
		}
