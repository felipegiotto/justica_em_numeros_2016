 ...
 * generated in the br.jus.cnj.modeloDeTransferenciaDeDados package. 
...
public class ObjectFactory {
    ...
    private final static QName _Intercomunicacao_QNAME = new QName("http://www.cnj.jus.br/modelo-de-transferencia-de-dados-1.0", "intercomunicacao");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.jus.cnj.modeloDeTransferenciaDeDados
     * 
     */
    ...
    /**
     * Create an instance of {@link TipoRelacaoIncidental }
     * 
     */
    public TipoRelacaoIncidental createTipoRelacaoIncidental() {
        return new TipoRelacaoIncidental();
    }
    ...
    /**
     * Create an instance of {@link TipoComplementoNacional }
     * 
     */
    public TipoComplementoNacional createTipoComplementoNacional() {
        return new TipoComplementoNacional();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.cnj.jus.br/modelo-de-transferencia-de-dados-1.0", name = "intercomunicacao")
