...
SELECT
  ...
  pd.id_oj_origem as cd_oj_origem, -- representa o código do órgão julgador de origem
  upper(pd.ds_oj_origem) as ds_oj_origem, 
  pd.id_oj_destino as cd_oj_destino, -- representa o código do órgão julgador de destino
