SELECT e.nm_logradouro, e.nr_endereco, e.ds_complemento, coalesce(cep.nm_bairro, e.nm_bairro) as nm_bairro, m.ds_municipio, uf.cd_estado, cep.nr_cep, mibge.id_municipio_ibge
...
LEFT JOIN tb_municipio_ibge mibge USING (id_municipio)
