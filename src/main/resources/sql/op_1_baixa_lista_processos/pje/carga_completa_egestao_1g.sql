...
from (
    select 
        ...
        fn_get_classe_data(pj.id_processo, to_date('31/07/2020','DD/MM/YYYY')) as num_classe_interno,
        fn_get_fase_processo(pj.id_processo, to_date('31/07/2020','DD/MM/YYYY')) fase
